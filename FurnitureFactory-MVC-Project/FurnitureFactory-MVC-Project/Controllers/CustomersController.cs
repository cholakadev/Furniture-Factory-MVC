namespace FurnitureFactory_MVC_Project.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public CustomersController(FurnitureFactoryDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CompanyName,Address,CompanyNumber,Representative.FirstName,Representative.PhoneNumber")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
